		  ...
		  <li class="active">Book Services</li>	  
			 ...
			 <div class="contact-grids">
				 <div class="col-md-6 contact-left">
					 <p>Réservez votre événement dès maintenant !</p>
					 <form method="post">
						 ...
						 <ul>
							 ...
							 <li class="text-info">Date de l'événement :</li>
							 <li><input type="date" class="form-control" name="edate" required="true"></li>
						 </ul>					 
						 <ul>
							 <li class="text-info">Heure Début :</li>
						 ...
						 <ul>
							 <li class="text-info">Heure Fin :</li>
						 ...
						 <ul>
							 <li class="text-info">Adresse de l'événement :</li>
							 <li><textarea type="text" class="form-control" name="vaddress" required="true" ></textarea></li>
						 </ul>
						 <ul>
							 <li class="text-info">Type de l'événement :</li>
...
<option value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
 <?php } ?>
						 ...
						 <ul>
							 <li class="text-info">Information supplémentaire:</li>
